...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUIEditor : UnityEditor.Editor
    {
        protected void OnEnable()
        {
            ...
            m_ActionLabelString = serializedObject.FindProperty("m_ActionLabelString");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.LabelField(m_CustomActionLabel, Styles.boldLabel);
            using (new EditorGUI.IndentLevelScope())
            {
                EditorGUILayout.PropertyField(m_OverrideActionLabelProperty);
                EditorGUILayout.PropertyField(m_ActionLabelString);
            }
        ...
        private SerializedProperty m_ActionLabelString;
        ...
        private GUIContent m_CustomActionLabel = new GUIContent("Custom Action Label UI");
